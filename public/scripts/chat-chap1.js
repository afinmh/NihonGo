...
function playAudioHappy(src) {
    ...
    let progress = 0; // gating untuk materi (index terakhir yang unlocked)
    const materiProgress = [0, 0, 0, 0, 0]; // progress setiap materi 0..1
    const materi1Played = new Set(); // simpan kata yang sudah dimainkan (materi 1)
    ...
    function mapAudioPath(src) {
        ...
        if (src.startsWith('/audio/kata-umum/')) {
            return src.replace('/audio/kata-umum/', '/audio/chapter1/dasar/');
        }
        return src;
    }
    ...
    async function startKataDasar() {
        ...
        testBtn.addEventListener('click', () => startKataDasarTest(groups));
    ...
    function startKataDasarTest(groups) {
    ...
    if (formEl) {
        formEl.addEventListener('submit', (e) => {
            ...
            if (correct) {
                ...
                playAudioHappy('/audio/chapter1/dasar/sugoi.mp3');
            } else {
...
function startChapter1() {
    ...
    function sendGreeting() {
        ...
        else if (hour >=15 && hour <19) { greetingText='Selamat sore!'; greetingAudio='/audio/chapter1/sore.mp3'; }
